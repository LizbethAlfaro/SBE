...
if (isset($con)) {
    ?>
    <div class="modal fade" id="acreditarEditarIntegrante" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="post" id="editar_integrante" name="editar_integrante">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_rut" name="rut" placeholder="Rut" required maxlength="12" onkeyup="validar(this.id)" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_nombre" name="nombre" placeholder="Nombres" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_apellido" name="apellido" placeholder="Apellidos" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='genero' id='ac_mod_genero' required>
                        ...
                        <div class="form-group">
                            <label for="mod_fechaNac" class="col-sm-3 control-label">Fecha Nacimiento</label>
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="ac_mod_fechaNac" name="fechaNac" placeholder="fechaNac" required>		  
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="mod_relacion" class="col-sm-3 control-label">Relacion</label>
                            <div class="col-sm-8">
                                <select class='form-control' name='relacion' id='ac_mod_relacion' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='estadoCivil' id='ac_mod_estado' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='nivelEducacional' id='ac_mod_nivel' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='actividadIntegrante' id='ac_mod_actividad' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='prevision' id='ac_mod_prevision' required onchange="acreditarOtraPrevEI(this.value)">
                        ...
                        <div class="form-group" id="otra-prev2" style="visibility: hidden">
                            <label for="mod_otraprevision" class="col-sm-3 control-label">Otra prevision</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_otraprevision" name="otraPrevision" placeholder="Prevision" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='condicion' id='ac_mod_condicion' required onchange="acreditarCondicionEnfermedadEI(this.value)">
                        ...
                        <div class="form-group" id="cond-enfermedad2" style="visibility: hidden">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_enfermedad" name="enfermedad" placeholder="Enfermedad" required>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary guardar_datos"  onclick="editarIntegrante()">Guardar datos</button>
                </div>       
