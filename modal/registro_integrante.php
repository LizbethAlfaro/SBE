...
if (isset($con)) {
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="post" id="guardar_integrante" name="guardar_integrante">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="rut" name="rut" placeholder="Rut" maxlength="12" onkeyup="validar(this.id)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nombre_integrante" name="nombre" placeholder="Nombres">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="apellido_integrante" class="col-sm-3 control-label">Apellidos</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="apellido_integrante" name="apellido" placeholder="Apellidos">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='genero' id='genero_integrante' >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="fechaNac_integrante" name="fechaNac" placeholder="fechaNac">		  
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='relacion' id='relacion_integrante'>
    ...
    while ($rw = sqlsrv_fetch_array($relacion)) {
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='estadoCivil' id='estadoCivil_integrante'>
    ...
    while ($rw = sqlsrv_fetch_array($estado)) {
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='nivelEducacional' id='nivelEducacional_integrante'>
    ...
    while ($rw = sqlsrv_fetch_array($nivel)) {
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='actividadIntegrante' id='actividadIntegrante'>
    ...
    while ($rw = sqlsrv_fetch_array($actividad)) {
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='prevision' id='prevision_integrante' onchange="otraPrev(this.value)">
    ...
    ?>
                        ...
                        <div class="form-group" id="otra-prev" style="visibility: hidden">
                            <label for="otraPrevision_integrante" class="col-sm-3 control-label">Otra prevision</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="otraPrevision_integrante" name="otraPrevision" placeholder="Prevision">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='condicion' id='condicion_integrante' onchange="condicionEnfermedad(this.value)">
    ...
    ?>
                        ...
                        <div class="form-group" id="cond-enfermedad" style="visibility: hidden">
                            <label for="enfermedad_integrante" class="col-sm-3 control-label">Enfermedad</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="enfermedad_integrante" name="enfermedad" placeholder="Enfermedad">
                            </div>
                        </div>	
                </div>
