...
if (isset($con)) {
    ?>
    <div class="modal fade" id="editarIntegrante" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="post" id="editar_integrante" name="editar_integrante">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_rut" name="rut" placeholder="Rut" required maxlength="12" onkeyup="validar(this.id)" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_nombre" name="nombre" placeholder="Nombres" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_apellido" name="apellido" placeholder="Apellidos" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='genero' id='mod_genero' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="mod_fechaNac" name="fechaNac" placeholder="fechaNac" required>		  
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='relacion' id='mod_relacion' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='estadoCivil' id='mod_estado' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='nivelEducacional' id='mod_nivel' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='actividadIntegrante' id='mod_actividad' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='prevision' id='mod_prevision' required onchange="otraPrev(this.value)">
                        ...
                        <div class="form-group" id="otra-prev2" style="visibility: hidden">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_otraprevision" name="otraPrevision" placeholder="Prevision" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='condicion' id='mod_condicion' required onchange="condicionEnfermedad(this.value)">
                        ...
                        <div class="form-group" id="cond-enfermedad2" style="visibility: hidden">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mod_enfermedad" name="enfermedad" placeholder="Enfermedad" required>
                            </div>
                        </div>
