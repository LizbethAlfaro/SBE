...
if (isset($con)) {
    ?>
    <div class="modal fade" id="acreditarEditarIntegranteEstudiante" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="post" id="editar_integrante" name="editar_integrante">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_rut_i_e" name="rut" placeholder="Rut" required maxlength="12" onkeyup="validar(this.id)" readonly >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='estadoCivil' id='ac_mod_estado_i_e' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='nivelEducacional' id='ac_mod_nivel_i_e' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='actividadIntegrante' id='ac_mod_actividad_i_e' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='prevision' id='ac_mod_prevision_i_e' required onchange="acreditarOtraPrevEI2(this.value)">
                        ...
                        <div class="form-group" id="otra-prev2" style="visibility: hidden">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_otraprevision_i_e" name="otraPrevision" placeholder="Prevision" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class='form-control' name='condicion' id='ac_mod_condicion_i_e' required onchange="acreditarCondicionEnfermedadEI2(this.value)">
                        ...
                        <div class="form-group" id="cond-enfermedad2" style="visibility: hidden">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ac_mod_enfermedad_i_e" name="enfermedad" placeholder="Enfermedad" required>
                            </div>
                        </div>
