	...
	<div class="modal fade" id="registro_becas_internas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_becas"></div>
				...
				<div class="col-sm-8">
                                    <input type="text" class="form-control" id="rut_estudiante_beca" name="rut" placeholder="Rut" required maxlength="12" onkeyup="validar(this.id)">
                                    <span class="error-rut"></span>
				</div>
			  </div>
                     
                           <div class="form-group">
                                <label class="col-sm-3 control-label">Renovante/Postulante </label>
                                <div class="col-sm-8">
                                    <select class='form-control' name='reno_post' id='reno_post'required>
                                      <option value="">Selecciona Tipo</option>  
                                      <option value="1">Postulante</option> 
                                      <option value="2">Renovante</option>  
                                    </select>                            
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-primary guardar_datos" onclick="especialEstudianteBeca()" >Guardar datos</button>
		  </div>
		  </form>
		</div>
	  </div>
        ...
        <script type="text/javascript" src="../js/funciones/casos_especiales.js"></script>
	<?php
		}
	?>