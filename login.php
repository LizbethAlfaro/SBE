...
<body>
    ...
    <?php
        ...
        include './modal/mensaje_inicio_proceso.php';
        
        include './modal/mail_cambiar_password.php';
...
<script>    
$( document ).ready(function() {
    $('#mensaje_inicio_proceso').modal('toggle')
});
</script>    
<?php     
     ...
     <div class="container-fluid">
         ...
         <div class="col-sm-6">
			...
			<?php
                ...
                <a data-toggle="modal" href="#cambiar_clave" >Restablecer contraseña</a>
                </div>
            </form><!-- /form -->
