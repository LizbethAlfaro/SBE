     ...
     ?>  
        ...
        <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <form id="enviar_formulario">
                    <div class="panel-body">
                        <div class="panel panel-default">
<!--                            <input id="guardar_datos" type="submit" class="btn btn-block btn-info" value="Enviar Formulario">-->
                            <button id="guardar_datos" type="submit" class="btn btn-block btn-info"><span class="glyphicon glyphicon-exclamation-sign"></span> Enviar Datos</button>
                         </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
...
<div class="separar"></div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading text-center">
                                <p>FIRMA&nbspY&nbspHUELLA</p><p>ESTUDIANTE</p>     
                            </div>
                            </div>         
                                            </td>
                                            <td>
                            ...
                            <div class="panel-heading text-center">
                                <p>FIRMA&nbspY&nbspTIMBRE</p><p>UFE</p>  
                            </div>
                            </div>     
                                            </td>
                                        </tr>
