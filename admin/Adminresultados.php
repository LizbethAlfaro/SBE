...
//TIPO DE SOLICITUD
include $_SERVER['DOCUMENT_ROOT'].'/Clases/Solicitud.php';
$condicion = "";
...
?>  
        ...
        $('#esp<?php echo $indice ?>').css('display','block');
                                      ...
                                      <div id="esp<?php echo $indice ?>" class="panel-body" style="display: none">
                                       ...
                                       <?php echo Scape::ms_escape_string($rw[21]); ?> </div>
                                    </div>
                                </div>
<!--<div class="panel panel-default">
...
<a href="AdminconvertirPDF_resultados.php?rut=<?php echo $rut ?>" class="btn btn-info">Descargar Comprobante</a>
</div> 
