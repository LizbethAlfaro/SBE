...
$( document ).ready(function() {
    $('#mensaje_beca_interna').modal('toggle')
...
$estudianteQuery = EstudianteBeca::recuperarEstudianteBeca($rut, $con, $condicion, "", "");
...
while ($estudianteCursor = sqlsrv_fetch_array($estudianteQuery)) {
    $estudianteArreglo = array(
        ...
        "direccion"     => $estudianteCursor['direccion_1'],
        "numero"        => $estudianteCursor['numero_1'],
        "departamento"  => $estudianteCursor['departamento_1'],
        "villa"         => $estudianteCursor['villa_1'],
        "comuna"        => $estudianteCursor['nombre_comuna'],
        "region"        => $estudianteCursor['nombre_region'],
        "direccion2"     => $estudianteCursor['direccion_2'],
        "numero2"        => $estudianteCursor['numero_2'],
        "departamento2"  => $estudianteCursor['departamento_2'],
        "villa2"         => $estudianteCursor['villa_2'],
        "comuna2"        => $estudianteCursor['comuna_2'],
        "region2"        => $estudianteCursor['region_2'],
    );
}
...
<?php 
    ...
    header("location: becaInterna.php?error=Estudiante No Encontado") ;   
}
?>