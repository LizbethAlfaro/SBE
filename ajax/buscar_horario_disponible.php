                            ...
                            for ($modulo = 1; $modulo <= 25; $modulo++) {
                                ...
                                if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_1_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_1_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_1_value == $fecha_registrada){
                                ...
                                $count = sqlsrv_num_rows($estado);
                                 ...
                                 if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_2_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_2_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_2_value == $fecha_registrada){
                                ...
                                $count = sqlsrv_num_rows($estado);
                                 ...
                                 if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_3_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_3_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_3_value == $fecha_registrada){
                ...
                ?> 
                               ...
                               if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_4_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_4_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_4_value == $fecha_registrada){
                                ...
                                $count = sqlsrv_num_rows($estado);
                                 ...
                                 if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_5_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_5_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_5_value == $fecha_registrada){
                ...
                ?> 
                                ...
                                if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_6_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_6_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_6_value == $fecha_registrada){
                                ...
                                $count = sqlsrv_num_rows($estado);
                                  ...
                                  if ($count > 0) {
                                    ...
                                    ?> 
                                        ...
                                        ?> 
                                        <label class="form-control no-border"><a id="a_<?php echo $dia_7_value; ?>_<?php echo $modulo; ?>" onclick="estadoSeleccionar(this.id,'<?php echo $rut_estudiante; ?>','<?php echo $modulo; ?>','<?php echo $dia_7_value; ?>')" class="btn btn-success seleccion">Disponible</a></label>
                                        <?php
                                    }
                                } else {
                                    if($modulo == $modulo_registrado && $dia_7_value == $fecha_registrada){
