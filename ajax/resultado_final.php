...
//enfermedades
            ...
            while($integranteCursor = sqlsrv_fetch_array($result_integrante)){
             ...
             //     $sumatoria+= $integranteCursor['puntaje_prev'];
...
//integrante                
            ...
            while($integrante_estudianteCursor = sqlsrv_fetch_array($result_integrante_estudiante)){
          ...
          //      echo $rut_estudiante;
//                if( strcmp($rut_estudiante,"14.014.474-6")== 0){
//               print_r(" rut ".$rut_estudiante." jefe ".$sumatoria_jefe."estudiante ".$sumatoria_estudiante);
//                }
      ...
      //      echo 'relacion: '.$relacion_jefe;
        ...
        ?>
         ...
         <tr>
            ...
            <td><?php echo $tipo_vivienda; ?></td>
            <td><?php echo $observacionArreglo['distancia']; ?></td>
            <td><?php echo $p_terr=($tenencia+$tipo_vivienda+$observacionArreglo['distancia']); ?></td>
            <td><?php echo $t_terr= round($p_terr*$ponderado_terr,2); ?></td>
            
            <!--SALUD-->
           
            <td><?php echo $promedio; ?></td>
            <td><?php echo $promedio_prev; ?></td>
            <td><?php echo $observacionArreglo['factor']; ?></td>
            <td><?php echo $observacionArreglo['duplicidad']; ?></td>
            <td><?php echo $extraArreglo['puntaje_sug']; ?></td>
            <td><?php echo $p_salu=($promedio+$promedio_prev+$observacionArreglo['factor']+$observacionArreglo['duplicidad']+$extraArreglo['puntaje_sug']); ?></td>
            <td><?php echo $t_salu= round($p_salu*$ponderado_salu,2); ?></td>
            
         
            
            <!--ECONOMICA-->
            <td><?php echo $puntaje_grupo; ?></td>
            <td><?php echo $puntaje_ingreso; ?></td>
            <td><?php echo $puntaje_pension; ?></td>
            <td><?php echo $promedio_nivel; ?></td>
            <td><?php echo $puntaje_percap; ?></td>
            <td><?php echo $observacionArreglo['tramo']; ?></td>
            <td><?php echo $puntaje_formula; ?></td>
            <td><?php echo $puntaje_jefe; ?></td>
            <td><?php echo $p_econ=($puntaje_grupo+$puntaje_ingreso+$puntaje_pension+$promedio_nivel+$puntaje_percap+$observacionArreglo['tramo']+$puntaje_formula+$puntaje_jefe); ?></td>
            <td><?php echo $t_econ =round($p_econ*$ponderado_econ,2); ?></td>
            ...
            <td><?php echo $p_acad=($extraArreglo['puntaje_av']+$extraArreglo['puntaje_cal']+$extraArreglo['puntaje_ben']+$extraArreglo['puntaje_pue']+$extraArreglo['puntaje_nac']); ?></td>
            <td><?php echo $t_acad=round($p_acad*$ponderado_acad,2); ?></td>
            
            <!--RESULTADO-->
            <td><?php echo ($p_terr+$p_salu+$p_econ+$p_acad); ?></td>
            <td><?php echo ($t_terr+$t_salu+$t_econ+$t_acad); ?></td>
