...
if($result_verificar){
   $contador_verificar = sqlsrv_num_rows($result_verificar); 
}else{
...
if($verificarArreglo['beca']=='42' or $verificarArreglo['beca']=='47' or $verificarArreglo['beca']==''){
    


//ESTUDIANTES PREGRADO Y VIGENTES
$result = UMAS::recuperarEstudiantePregrado($rut,$con);
...
//////
  ...
  //  $contar = sqlsrv_num_rows($comprobar);
    ...
    $errors[] = "Lo sentimos , ya cuenta con otras becas no compatibles con el proceso. Acérquese a UFE para mayor informacion";  
}



}else{
    $errors[] = "El proceso ha Concluido";  
}
