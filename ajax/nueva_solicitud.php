...
//           $errors[] = "Villa vacía";
		...
		require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                if ($query){
                    $messages[] = "Solicitud enviada a revision.";
                    
                    $tipo_notificacion=3;
                    obtenerSolicitud($rut_estudiante,$con);
                    Mail::enviarMail($nombre_estudiante,$nombre_asistente,$tipo_notificacion,$mail_estudiante,$imagen,$fecha);
		} else{
                    $errors []= "Error al ingresar solicitud";
		}
